...
<div id="main-carousel" class="carousel">
    <div class="europa-inner">
        <div class="item active">
            <img src="{{ asset('image/Europa.jpg') }}">
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="panel panel-deafult">
                ...
                <div class="panel-body">
                    <div class="img-box">
                        <img src="{{ asset('image/search.png') }}" class="box-img">
                    </div>
                    <div>
        ...
        <div class="col-sm-4">
            <div class="panel panel-deafult">
                ...
                <div class="panel-body">
                    <div class="img-box">
                        <img src="{{ asset('image/upload.png') }}" class="box-img">
                    </div>
                    <div>
        ...
        <div class="col-sm-4">
            <div class="panel panel-deafult">
                ...
                <div class="panel-body">
                    <div class="img-box">
                        <img src="{{ asset('image/eventnotice.png') }}" class="box-img">
                    </div>
                    <div>
