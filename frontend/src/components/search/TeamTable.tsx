      ...
      <table className="min-w-full">
        ...
        <tbody>
          {teams.map((team, index) => (
            <tr
              key={team.id}
              className={`${index % 2 === 0 ? 'bg-black/70' : 'bg-black/80'} border-b border-blue-900/20 hover:bg-blue-900/10 transition-colors duration-150`}
            >
              ...
              <td className="px-6 py-5">
                {team.comment.split('\n').map((line, i) => (
                  <div
                    ...
                    className={
                      i === 0
                        ? 'text-base font-medium text-blue-300 mb-1'
              ...
              <td className="px-6 py-5 whitespace-nowrap break-keep">
                <div className="text-base text-blue-400 hover:text-blue-300 transition-colors duration-200 break-keep whitespace-nowrap">
                  {team.file_name}
                </div>
              </td>
              <td className="px-6 py-5 whitespace-nowrap">
