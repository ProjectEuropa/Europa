...
const FeaturesSection: React.FC = () => {
  const features: FeatureItem[] = [
    {
      icon: (
        <svg width={36} height={36} viewBox="0 0 24 24" fill="none" stroke="#00c8ff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    },
    {
      icon: (
        <svg width={36} height={36} viewBox="0 0 24 24" fill="none" stroke="#00c8ff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <path d="M12 8V16"/>
          <circle cx="12" cy="6.5" r="0.5" fill="#00c8ff" stroke="#00c8ff" strokeWidth="0.5"/>
        </svg>
      ),
      title: '情報',
        ...
        <div style={{
          ...
          {features.map((feature, index) => (
            <div key={index} style={{
              ...
              <div style={{ color: "#00c8ff", fontSize: "0.98rem", fontWeight: 600, marginBottom: "12px" }}>
                {feature.title.replace('データ', ' Data').replace('シンプル', 'Simple ').replace('情報', 'Information')}
              </div>
