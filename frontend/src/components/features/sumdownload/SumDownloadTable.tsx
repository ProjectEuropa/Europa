...
export const SumDownloadTable = ({
  ...
  return (
    <>
      {/* Desktop Table View (768px以上) */}
      <div className="hidden md:block w-full overflow-x-auto mt-6 rounded-lg border border-slate-800 bg-slate-900/50 backdrop-blur-sm shadow-xl">
