...
export function TimelineItem({
    ...
    return (
        <div className="relative flex items-center gap-4 md:gap-6 pb-5 last:pb-0">
            {/* 左側：年 */}
            <div className="text-lg md:text-xl font-bold text-cyan-400 font-mono w-14 md:w-16 text-right shrink-0">
                {year}
            </div>
...
// メタ情報（最終更新日など）
export function MetaInfo({ children }: { children: React.ReactNode }) {
