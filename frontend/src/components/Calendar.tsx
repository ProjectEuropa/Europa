      ...
      {modalEvent && (
        ...
        >
          ...
          >
            ...
            <div id="event-modal-description" tabIndex={0} className="mb-4 text-cyber-text leading-relaxed whitespace-pre-wrap max-h-60 sm:max-h-80 overflow-y-auto custom-scrollbar">
              {modalEvent.details}
            </div>
            {modalEvent.url && (
              <div className="mt-4">
