  ...
  const links = [
    {
      ...
      description: "アートディンク社が提供する公式サイト。ゲームの基本情報や最新情報を確認できます。"
    },
    {
      title: "Carnage Heart EXA 2chまとめwiki",
      url: "https://w.atwiki.jp/chex/",
      description: "コミュニティによって運営されているwiki。戦術やテクニックなど、詳細な情報が集約されています。"
    },
    {
      title: "Discord コミュニティ",
      url: "https://discord.gg/aXT3DNU8A4",
      description: "リアルタイムでプレイヤー同士が交流できるDiscordサーバー。質問や情報交換に最適です。"
    },
    {
      title: "mixi コミュニティ",
      url: "https://mixi.jp/view_community.pl?id=5138413",
      description: "mixiで運営されているコミュニティページ。長年の歴史を持つ交流の場です。"
    }
  ];
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              カルネージハートEXAに関連する公式・非公式の外部サイトへのリンク集です。<br />
