          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <h3 style={{ fontSize: "20px", color: "#00c8ff", marginBottom: "12px" }}>データ共有</h3>
                <p>
              ...
              <div style={{
                ...
                <h3 style={{ fontSize: "20px", color: "#00c8ff", marginBottom: "12px" }}>マッチ分析</h3>
                <p>
              ...
              <div style={{
                ...
                <h3 style={{ fontSize: "20px", color: "#00c8ff", marginBottom: "12px" }}>コミュニティ</h3>
                <p>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <p>プロジェクト発足<br />基本的なデータ共有機能の実装</p>
              </div>
              ...
              <div style={{
                ...
                <p>プラットフォーム全面リニューアル第1弾<br />UIを大幅に改善</p>
              </div>
              ...
              <div style={{
                ...
                <p>プラットフォーム全面リニューアル第2弾<br />最新技術によるパフォーマンス向上</p>
              </div>
            </div>
            ...
            <div style={{
              ...
              <h3 style={{ fontSize: "20px", color: "#00c8ff", marginBottom: "16px" }}>今後の開発予定</h3>
              <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
                <li style={{ marginBottom: "10px" }}>AIを活用した戦術分析機能</li>
                <li style={{ marginBottom: "10px" }}>コミュニティイベント管理システム</li>
